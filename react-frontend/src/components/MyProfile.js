...
export default function MyProfile() {
    ...
    return (
        ...
        <ul class="dropdown-menu">
            <li><Link to={"/accountDetails"} className="nav-link nav-item_join">Ustawienia</Link></li>
            {/*<li onClick={logout}>Wyloguj się</li>*/}
            <li><Link to={"/"} className="nav-link nav-item_join" onClick={logout}>Wyloguj się</Link></li>
        </ul>
    </div>
    )
}